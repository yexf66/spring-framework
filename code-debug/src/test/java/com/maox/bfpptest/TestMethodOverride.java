...
import com.maox.base.methodOverrides.lookup.Apple;
import com.maox.base.methodOverrides.lookup.Fruit;
import com.maox.base.methodOverrides.lookup.FruitPlate;
...
//		System.out.println(bean2.getBanana());
		FruitPlate fruitplate1 = (FruitPlate) ac.getBean("fruitplate2");
		Fruit f1 = fruitplate1.getFruit();
		FruitPlate fruitplate2 = (FruitPlate) ac.getBean("fruitplate2");
		Fruit f2 = fruitplate2.getFruit();
//		FruitPlate fruitplate2 = (FruitPlate) ac.getBean("fruitplate2");
		Fruit f3 = fruitplate2.getFruit();
